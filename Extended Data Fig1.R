# Extended Data Fig. 1 | Stratified generalized estimating equation (GEE) to compare 
# HPV vaccination-specific consultation with health professionals between two arms.
...
dt <- read_excel("./data/ED_fig1_healthcare_consultation_forestplot_data.xlsx")
...
ggsave("./Figures/Extended_Data_Fig1.pdf", plot = g, device = "pdf", width = 8, height = 7, units = "in")
ggsave("./Figures/Extended_Data_Fig1.png", plot = g, width = 9, height = 7, units = "in", dpi = 600)
